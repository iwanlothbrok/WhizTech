        ...
        <section className="hero d-flex flex-column  justify-content-center align-items-center mt-4" id="intro">
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="d-flex flex-column justify-content-center align-items-center col-lg-6    col-md-7 col-12 text-white bg-secondary mt-4 ">
                        <div className="hero-text">
                            <h1 className="hero-title">Иван Цветанов Иванов<p style={green}>Software Developer</p></h1>
                            <p className='mb-2'><strong>Иван Иванов</strong> е специалист с повече от <strong>1000 часа</strong> в преподаването и е работил с над <strong>30 обучаеми.</strong> <br />
                            ...
                            <Link to='/course' onClick={onClickHandle}>  <button className='btn btn-lg mt-3 mb-5 consultationBtn'>КОНСУЛТАЦИЯ</button> </Link>
                        </div>
                    </div>
                </div>
            </div>
