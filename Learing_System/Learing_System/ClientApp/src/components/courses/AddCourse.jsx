                                        ...
                                        <div className="p-5">
                                            ...
                                            <div className="mb-4 pb-2">
                                                <div className="form-outline">
                                                    <label className="form-label" htmlFor="form3Examplev4">Title</label>
                                            ...
                                            <div className="mb-4 pb-2">
                                                <div className="form-outline">
                                                    <label className="form-label" htmlFor="form3Examplev4">Price</label>
                                                    <input type="text" id="form3Examplev4" className="form-control form-control-lg" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                                                    <div className="form-outline">
                                                        ...
                                                        <label className="form-label" htmlFor="form3Examplev5">Business Arena</label>
                                                    </div>
                                                </div>
