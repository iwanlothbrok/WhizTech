                                    ...
                                    <ul className="border-bottom mb-30 mt-md-4 pb-3 text-left">
                                        <li>
                                            <p class="mb-2">
                                                ...
                                                Плащайте фиксирана месечна такса за редовни уроци по график, което гарантира последователно обучение и напредък.
                                            </p>
                                        </li>
                                        <li>
                                            <p class="mb-2">
                                                ...
                                                Уроците са планирани така, че да поддържат постоянен образователен напредък, съобразен с вашата обучителна програма.
                                            </p>
                                        </li>
                                        <li>
                                            <p class="mb-2">
                                        ...
                                        <li>
                                            <p class="mb-2">
                                                ...
                                                Получавате достъп до специални материали и бонус сесии, които не са достъпни за неабонати.
                                            </p>
                                        </li>
                                        <li>
                                            <p class="mb-2">
